...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    private static final String URLREGISTER = "http://10.0.2.2:8001/register/json/data";
//    private static final String URLREGISTER = "http://39.97.120.118:8001/register/json/data";
