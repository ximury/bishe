...
public class LoginActivity extends Activity {
    ...
    private static final String URLLOGIN = "http://10.0.2.2:8001/login/json/data";
//    private static final String URLLOGIN = "http://39.97.120.118:8001/login/json/data";
                        ...
                        public void handleMessage(Message msg) {
                            ...
                            switch (msg.what) {
                                ...
                                case 1:
                                    ...
                                    startActivity(new Intent(LoginActivity.this, MainTabViewActivity.class));
